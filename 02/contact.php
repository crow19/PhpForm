            ...
            <div id="main">
                ...
                <div id="main1">
                    ...
                    <form id="form" name="form" method="post" action="result.php">
                        ...
                        <div class="main_bar">
                            ...
                            <!--右側-->
                            <div id="name_right1">
                                <input type="text" name="number" maxlength="4" onKeyup="this.value=this.value.replace(/[^0-9a-z]+/i,'')" required="required"> -
                                <input type="text" name="number2" maxlength="4" onKeyup="this.value=this.value.replace(/[^0-9a-z]+/i,'')" required="required"> -
                                <input type="text" name="number3" maxlength="4" onKeyup="this.value=this.value.replace(/[^0-9a-z]+/i,'')" required="required">
                            </div>
                        </div>
                        <!--clear_box(左寄せ、または右寄せされた全ての要素に対する回り込みを解除)の設定-->
                        <div class="clear_box"></div>
                ...
                <div id="main2">
                    ...
                    <div class="main1_bar1">
                        ...
                        <!--右側-->
                        <div id="textarea">
                            <textarea name="question1" cols="70" rows="5" maxlength="50" placeholder="質問内容をご記入ください" required="required"></textarea>
                        </div>
                    </div>
                    <!--clear_box(左寄せ、または右寄せされた全ての要素に対する回り込みを解除)の設定-->
                    <div class="clear_box"></div>
